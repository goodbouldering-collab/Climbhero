...
(
  ...
  'Through collaboration with Gubbol Bouldering Cafe & Shop, I\'ve experienced ClimbHero\'s educational value firsthand. The problem design based on data from 25,000 annual gym users, combined with fitting data from 120+ shoe models, represents an unprecedented industry approach. Since shoe selection directly impacts climbing performance, the seamless support from LINE consultation → EC → in-store fitting → gym testing is especially reassuring for female climbers. Data-driven training analysis enables efficient skill improvement.',
